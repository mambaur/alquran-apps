...
public class CovidActivity extends AppCompatActivity {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Configuration.baseURLCovid, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    txtDate.setText(getMonth(dataNow.getString("tanggal")));
    ...
    private String getMonth(String dateRespon){
        String result = "";
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
        try {
            Date date = dateFormat.parse(dateRespon);
            DateFormat dateResult = new SimpleDateFormat("EEEE, dd MMMM yyyy");
            result = dateResult.format(date);
